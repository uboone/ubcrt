////////////////////////////////////////////////////////////////////////
// Class:       T0recoCRTTrackAnal
// Module Type: analyzer
// File:        T0recoCRTTrackAnal_module.cc
//
...
class crt::T0recoCRTTrackAnal : public art::EDAnalyzer {
public:
  explicit T0recoCRTTrackAnal(fhicl::ParameterSet const & p);
  // The destructor generated by the compiler is fine for classes
  // without bare pointers or other resource use.

  // Plugins should not be copied or assigned.
  T0recoCRTTrackAnal(T0recoCRTTrackAnal const &) = delete;
  T0recoCRTTrackAnal(T0recoCRTTrackAnal &&) = delete;
  T0recoCRTTrackAnal & operator = (T0recoCRTTrackAnal const &) = delete;
  T0recoCRTTrackAnal & operator = (T0recoCRTTrackAnal &&) = delete;
...
crt::T0recoCRTTrackAnal::T0recoCRTTrackAnal(fhicl::ParameterSet const & p)
  :
  EDAnalyzer(p),
...
void crt::T0recoCRTTrackAnal::analyze(art::Event const & evt)
{
...
void crt::T0recoCRTTrackAnal::beginJob()
{
...
void crt::T0recoCRTTrackAnal::endJob()
{
...
void crt::T0recoCRTTrackAnal::SortTrackPoints(const recob::Track& track, std::vector<recob::Track::Point_t>& sorted_trk)
{
...
DEFINE_ART_MODULE(crt::T0recoCRTTrackAnal)
