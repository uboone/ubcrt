 ...
 */
class CRTNeutrinoIdBaseTool
{
public:
    virtual ~CRTNeutrinoIdBaseTool() noexcept = default;
    ...
    virtual void ClassifySlicesCRTHit(SliceVector &slices, const art::Event &evt, std::string m_crthitLabel) = 0;
};
