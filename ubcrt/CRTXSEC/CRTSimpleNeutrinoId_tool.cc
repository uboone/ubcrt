/**
 *  @file   larpandora/LArPandoraEventBuilding/LArPandoraCRTSimpleNeutrinoId_tool.cxx
 *
 ...
 */
class CRTSimpleNeutrinoId : NeutrinoIdBaseTool
{
public:
    /**
     ...
     */
    CRTSimpleNeutrinoId(fhicl::ParameterSet const &pset);
...
DEFINE_ART_CLASS_TOOL(CRTSimpleNeutrinoId)
...
CRTSimpleNeutrinoId::CRTSimpleNeutrinoId(fhicl::ParameterSet const &/*pset*/)
{
}

//------------------------------------------------------------------------------------------------------------------------------------------

void CRTSimpleNeutrinoId::ClassifySlices(SliceVector &slices, const art::Event &/*evt*/) 
{
